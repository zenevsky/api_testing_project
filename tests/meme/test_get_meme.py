...
class TestGetMeme:
    ...
    def test_get_meme_with_auth(self, get_meme_endpoint, request, meme_id_fixture):
    ...
    def test_get_meme_without_auth(self, get_meme_endpoint, meme_id_fixture):
        get_meme_endpoint.get_meme(meme_id_fixture)
        get_meme_endpoint.check_that_status_is_401()

    @pytest.mark.medium
    @allure.title('Get not existing meme')
    def test_get_not_existing_meme(self, get_meme_endpoint, delete_meme_endpoint, request, meme_id_fixture):
